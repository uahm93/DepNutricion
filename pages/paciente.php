...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"><br>
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="recordatorio24horas.php"><i class="fa fa-fw fa-edit"></i> Recordatorio 24 horas</a>
                    </li>
                    <li>  <select class="form-control" name="escolaridad" reqsuired>
               
                 <option value="">Tipo de paciente</option>
               <option a href="paciente.php" value="">Mujeres</option>
               <option value="bachillerato">Hombres</option>
               <option value="tecnico">Niños</option>
               <option value="profesional">Niñas</option>
             </select></li>
  ...
  <form action="queryspaciente.php" method="POST">
		 <br><br><br> <br><br>
		 <table  class="table table-hover">
          ...
          <td>
            <input type='hidden' id='fecha' class="form-control" name="fecha_consulta" value="<?php echo date('Y-m-d'); ?>" requsired />
          </td>
        </tr>   
				<tr class="warning">
					<td>
					...
					<td>
						<input type='text' class="form-control" value="" name="nombre" placeholder="Escribe el nombre.." size="3" autofocus="autofocus" requsired />
					</td>
				</tr>
				...
				<tr class="warning">
					...
					<td>
						<input type='text' id='NSS' name ="NSS"placeholder="11 digitos" class="form-control" maxlength="11" size="10" requsired />
					</td>
				</tr>
				<tr class="warning">
					<td>
					...
					<td>
						<input type='date' id='fecha' class="form-control" name="fecha_nacimiento" value="<?php echo date('Y-m-d'); ?>" requsired />
					</td>
				</tr>
				<tr class="warning">
					<td>
		    		<label>Sexo:</td><td></label>
			  		<label><input type='radio' name="sexo" id='sexo' value="Hombre" checked="checked" requisred /> Hombre</label>
			  		<label><input type='radio' name="sexo" id='sexo' value="Mujer" requisred /> Mujer 
					 </label></td>
				</tr>
				...
				<tr class="success">
					...
					<td>
							<select class="form-control" name="escolaridad" reqsuired>
				...
				<tr class="success">
					...
					<td>
						<input type='text' id='ocupacion' name="ocupacion" class="form-control" placeholder="ocupacion" size="30"/>
					</td>
				</tr>
				<tr class="success">
					<td>
					...
					<tr class="success">
							<td>Adultos <input name="adultos" type='number' id='peso_corregido'  min="0" max="50" step="1" class="form-control"  size="2"   /></td>
					        <td>Menores <input name="menores" type='number' id='peso_corregido'  min="0" max="50" step="1" class="form-control"  size="2"   /></td>
					</tr>
				</tr>
				<tr class="success">
					<td>
					...
					<td>
							<select class="form-control" name="ejercicio" requirsed>
...
<div class="table-responsive">
  ...
  <tbody>
	...
	<tr class="active">
      <td><label>Bajo peso <br><input value ="bajo_peso" type="checkbox" name="bajoPeso" /></label></td>
      <td><label>Hipertenciòn<br><input value ="hipertencion"  type="checkbox" name="hipertencion" /></label></td>
      <td><label>Cancer <br><input value ="Cancer" type="checkbox" name="cancer" /></label></td>
	  <td><label>Alcoholismo<br><input value ="Alcoholismo" type="checkbox"  name="alcoholismo" /></label></td>
    </tr class="active">
    
	<tr class="active">
      <td><label>Sobre peso<br><input value ="Sobre peso"  type="checkbox" name="sobrePeso" /></label> </td>
       					...
       					<table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="success">
                                        ...
                                        <td><input class="form-control" type="num"  id="leucocitos" name="leucocitos" size="1" /></td>
		 ...
		 <table  class="table table-hover">
				...
				<tr class="active">
					...
					<td>
						...
						<input onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" type="text" id="peso_actual" class="form-control" value="" name="peso_actual" placeholder="Peso en KG">
					</td>
				</tr>
				<tr class="active">
					<td>
					...
					<td>
						<input onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" type='number' class="form-control" size="3"  id='peso_habitual' name="peso_habitual" name="peso_habitual" placeholder="Peso en KG"  step="any" requirwed/>
				</tr>
				<tr class="active">
					<td>
				...
				<tr class="active">
					...
					<td>
						...
						<input onblur="if(this.value == ''){this.value='0'}" onKeyUp="suma();"  class="form-control" type="text" name="estatura" id="estatura" value="" placeholder="Estatura en MTS">
					</td>
				</tr>
				<tr class="active">
					<td>
					...
					<td>
						<input onblur="if(this.value == ''){this.value='0'}" onKeyUp="icc();"  type='number' id="cintura" name ="cintura" placeholder="Tamaño cintura en CM" class="form-control"  size="10" reqwuired />
					</td>
				</tr>
				<tr class="active">
					<td>
					...
					<td>
						<input onblur="if(this.value == ''){this.value='0'}" onKeyUp="icc();" type='number' id='cadera' class="form-control" name="cadera" placeholder="Tamaño cadera en CM" requiwred />
					</td>
				</tr>
				...
				<tr class="active">
					...
					<td>
						<input type='number' class="form-control" size="3"  id='perimetro_abd' name="perimetro_abdominal" placeholder="Perimetro abdominal en CM"  step="any" requirwed/>
				</tr>
				<tr class="active">
					<td>
					...
					<td>
						<input type='number' id='circ_muñeca' name="circunferencia_muneca"  class="form-control"   size="3" placeholder="Tamaño muñeca en CM"  requwired />
					</td>
				</tr>
				<tr class="active">
					<td>
				...
				<tr class="active">
					...
					<td>
						<input type="submit" class="btn btn-lg btn-primary" name="enviar" value="Enviar datos">
					</td>
                    <td>
                        <a href="http://localhost:81/IMSS%20v3/pages/PHP/examples/example_048.php" type="button" class="btn btn-lg btn-primary">Imprimir reporte <i class="fa fa-file-pdf-o"></i></a>
                    </td>
				</tr>
</tbody>				
	       </form>
